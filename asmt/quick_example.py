...
if __name__ == '__main__':
    ...
    q = 2  # Aspirational
    parameter_set = 2  # Choose which set of parameters to use [1,2,3] (See options below)
    ...
    '''
    asmt = ASMT(**qsft_args)
    result = asmt.transform(test_signal, verbosity=5, timing_verbose=True, report=True, sort=True)
